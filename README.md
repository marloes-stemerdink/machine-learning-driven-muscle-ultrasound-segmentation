...
Contact marloes.stemerdink@radboudumc.nl for the report on previous testing finetuning on an ultrasound device and populations beyond those on which the model was trained.
